    ...
    Partial Public Class Gemini_MediaTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Gemini_Media` (`UID`, `Title`, `Filename`, `Location_ID`, `Type_ID`,"& _ 
                ...
                "_SD`, `Archived_Date_SD`, `Unarchived_Date_SD`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, "& _ 
                "?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,"& _ 
                " ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Gemini_Media` SET `UID` = ?, `Title` = ?, `Filename` = ?, `Location_ID` ="& _ 
                ...
                " = ? WHERE ((`ID` = ?) AND ((? = 1 AND `UID` IS NULL) OR (`UID` = ?)) AND ((? = "& _ 
                "1 AND `Title` IS NULL) OR (`Title` = ?)) AND ((? = 1 AND `Filename` IS NULL) OR "& _ 
                "(`Filename` = ?)) AND ((? = 1 AND `Location_ID` IS NULL) OR (`Location_ID` = ?))"& _ 
                " AND ((? = 1 AND `Type_ID` IS NULL) OR (`Type_ID` = ?)) AND ((? = 1 AND `Promote"& _ 
                "_Five` IS NULL) OR (`Promote_Five` = ?)) AND ((? = 1 AND `Promote_Five_Star` IS "& _ 
                "NULL) OR (`Promote_Five_Star` = ?)) AND ((? = 1 AND `Promote_Five_US` IS NULL) O"& _ 
                "R (`Promote_Five_US` = ?)) AND ((? = 1 AND `Promote_Demand_Five` IS NULL) OR (`P"& _ 
                "romote_Demand_Five` = ?)) AND ((? = 1 AND `Use_DVE` IS NULL) OR (`Use_DVE` = ?))"& _ 
                " AND ((? = 1 AND `Use_Menu` IS NULL) OR (`Use_Menu` = ?)) AND ((? = 1 AND `First"& _ 
                "_Use` IS NULL) OR (`First_Use` = ?)) AND ((? = 1 AND `Last_Use` IS NULL) OR (`La"& _ 
                "st_Use` = ?)) AND ((? = 1 AND `Generic` IS NULL) OR (`Generic` = ?)) AND ((? = 1"& _ 
                " AND `Created` IS NULL) OR (`Created` = ?)) AND ((? = 1 AND `Modified` IS NULL) "& _ 
                "OR (`Modified` = ?)) AND ((? = 1 AND `Producer` IS NULL) OR (`Producer` = ?)) AN"& _ 
                "D ((? = 1 AND `Prog_TX_Start` IS NULL) OR (`Prog_TX_Start` = ?)) AND ((? = 1 AND"& _ 
                " `Prog_TX_End` IS NULL) OR (`Prog_TX_End` = ?)) AND ((? = 1 AND `Delivery_Date` "& _ 
                "IS NULL) OR (`Delivery_Date` = ?)) AND ((? = 1 AND `Duration` IS NULL) OR (`Dura"& _ 
                "tion` = ?)) AND ((? = 1 AND `Delivery_1` IS NULL) OR (`Delivery_1` = ?)) AND ((?"& _ 
                " = 1 AND `Delivery_2` IS NULL) OR (`Delivery_2` = ?)) AND ((? = 1 AND `Delivery_"& _ 
                "3` IS NULL) OR (`Delivery_3` = ?)) AND ((? = 1 AND `Format_1` IS NULL) OR (`Form"& _ 
                "at_1` = ?)) AND ((? = 1 AND `Format_2` IS NULL) OR (`Format_2` = ?)) AND ((? = 1"& _ 
                " AND `Format_3` IS NULL) OR (`Format_3` = ?)) AND ((? = 1 AND `Location_1` IS NU"& _ 
                "LL) OR (`Location_1` = ?)) AND ((? = 1 AND `Location_2` IS NULL) OR (`Location_2"& _ 
                "` = ?)) AND ((? = 1 AND `Location_3` IS NULL) OR (`Location_3` = ?)) AND ((? = 1"& _ 
                " AND `Delivery_Notes` IS NULL) OR (`Delivery_Notes` = ?)) AND ((? = 1 AND `Sprea"& _ 
                "dsheet` IS NULL) OR (`Spreadsheet` = ?)) AND ((? = 1 AND `Use_USA_Menu_BG` IS NU"& _ 
                "LL) OR (`Use_USA_Menu_BG` = ?)) AND ((? = 1 AND `Circle_Treatment_ID` IS NULL) O"& _ 
                "R (`Circle_Treatment_ID` = ?)) AND ((? = 1 AND `Promote_BB` IS NULL) OR (`Promot"& _ 
                "e_BB` = ?)) AND ((? = 1 AND `Packaged` IS NULL) OR (`Packaged` = ?)) AND ((? = 1"& _ 
                " AND `Package_Date` IS NULL) OR (`Package_Date` = ?)) AND ((? = 1 AND `Package_F"& _ 
                "ilename` IS NULL) OR (`Package_Filename` = ?)) AND ((? = 1 AND `Missing` IS NULL"& _ 
                ") OR (`Missing` = ?)) AND ((? = 1 AND `Archived` IS NULL) OR (`Archived` = ?)) A"& _ 
                "ND ((? = 1 AND `Archived Date` IS NULL) OR (`Archived Date` = ?)) AND ((? = 1 AN"& _ 
                "D `Unarchived Date` IS NULL) OR (`Unarchived Date` = ?)) AND ((? = 1 AND `Packag"& _ 
                "ed_SD` IS NULL) OR (`Packaged_SD` = ?)) AND ((? = 1 AND `Package_Date_SD` IS NUL"& _ 
                "L) OR (`Package_Date_SD` = ?)) AND ((? = 1 AND `Package_Filename_SD` IS NULL) OR"& _ 
                " (`Package_Filename_SD` = ?)) AND ((? = 1 AND `Missing_SD` IS NULL) OR (`Missing"& _ 
                "_SD` = ?)) AND ((? = 1 AND `Archived_SD` IS NULL) OR (`Archived_SD` = ?)) AND (("& _ 
                "? = 1 AND `Archived_Date_SD` IS NULL) OR (`Archived_Date_SD` = ?)) AND ((? = 1 A"& _ 
                "ND `Unarchived_Date_SD` IS NULL) OR (`Unarchived_Date_SD` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        ID, UID, Title, Filename, Location_ID, Type_ID, Promote_Five, Promo"& _ 
                ...
                "rchived_SD, Archived_Date_SD, Unarchived_Date_SD"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Gemini_Media"
        ...
        Public Overloads Overridable Function Delete( _
                    ...
                    ByVal Original_Circle_Treatment_ID As Global.System.Nullable(Of Integer),  _
                    ByVal Original_Promote_BB As Boolean,  _
                    ByVal Original_Packaged As Boolean,  _
                    ByVal Original_Package_Date As Global.System.Nullable(Of Date),  _
                    ByVal Original_Package_Filename As String,  _
                    ByVal Original_Missing As Boolean,  _
                    ByVal Original_Archived As Boolean,  _
                    ByVal Original_Archived_Date As Global.System.Nullable(Of Date),  _
                    ByVal Original_Unarchived_Date As Global.System.Nullable(Of Date),  _
                    ByVal Original_Packaged_SD As Boolean,  _
                    ByVal Original_Package_Date_SD As Global.System.Nullable(Of Date),  _
                    ByVal Original_Package_Filename_SD As String,  _
                    ByVal Original_Missing_SD As Boolean,  _
                    ByVal Original_Archived_SD As Boolean,  _
                    ByVal Original_Archived_Date_SD As Global.System.Nullable(Of Date),  _
                    ByVal Original_Unarchived_Date_SD As Global.System.Nullable(Of Date)) As Integer
            ...
            Me.Adapter.DeleteCommand.Parameters(70).Value = CType(Original_Promote_BB,Boolean)
            Me.Adapter.DeleteCommand.Parameters(71).Value = CType(0,Object)
            Me.Adapter.DeleteCommand.Parameters(72).Value = CType(Original_Packaged,Boolean)
            If (Original_Package_Date.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(73).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(74).Value = CType(Original_Package_Date.Value,Date)
            Else
                Me.Adapter.DeleteCommand.Parameters(73).Value = CType(1,Object)
                Me.Adapter.DeleteCommand.Parameters(74).Value = Global.System.DBNull.Value
            End If
            If (Original_Package_Filename Is Nothing) Then
                Me.Adapter.DeleteCommand.Parameters(75).Value = CType(1,Object)
                Me.Adapter.DeleteCommand.Parameters(76).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(75).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(76).Value = CType(Original_Package_Filename,String)
            End If
            Me.Adapter.DeleteCommand.Parameters(77).Value = CType(0,Object)
            Me.Adapter.DeleteCommand.Parameters(78).Value = CType(Original_Missing,Boolean)
            Me.Adapter.DeleteCommand.Parameters(79).Value = CType(0,Object)
            Me.Adapter.DeleteCommand.Parameters(80).Value = CType(Original_Archived,Boolean)
            If (Original_Archived_Date.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(81).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(82).Value = CType(Original_Archived_Date.Value,Date)
            Else
                Me.Adapter.DeleteCommand.Parameters(81).Value = CType(1,Object)
                Me.Adapter.DeleteCommand.Parameters(82).Value = Global.System.DBNull.Value
            End If
            If (Original_Unarchived_Date.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(83).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(84).Value = CType(Original_Unarchived_Date.Value,Date)
            Else
                Me.Adapter.DeleteCommand.Parameters(83).Value = CType(1,Object)
                Me.Adapter.DeleteCommand.Parameters(84).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.DeleteCommand.Parameters(85).Value = CType(0,Object)
            Me.Adapter.DeleteCommand.Parameters(86).Value = CType(Original_Packaged_SD,Boolean)
            If (Original_Package_Date_SD.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(87).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(88).Value = CType(Original_Package_Date_SD.Value,Date)
            Else
                Me.Adapter.DeleteCommand.Parameters(87).Value = CType(1,Object)
                Me.Adapter.DeleteCommand.Parameters(88).Value = Global.System.DBNull.Value
            End If
            If (Original_Package_Filename_SD Is Nothing) Then
                Me.Adapter.DeleteCommand.Parameters(89).Value = CType(1,Object)
                Me.Adapter.DeleteCommand.Parameters(90).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(89).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(90).Value = CType(Original_Package_Filename_SD,String)
            End If
            Me.Adapter.DeleteCommand.Parameters(91).Value = CType(0,Object)
            Me.Adapter.DeleteCommand.Parameters(92).Value = CType(Original_Missing_SD,Boolean)
            Me.Adapter.DeleteCommand.Parameters(93).Value = CType(0,Object)
            Me.Adapter.DeleteCommand.Parameters(94).Value = CType(Original_Archived_SD,Boolean)
            If (Original_Archived_Date_SD.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(95).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(96).Value = CType(Original_Archived_Date_SD.Value,Date)
            Else
                Me.Adapter.DeleteCommand.Parameters(95).Value = CType(1,Object)
                Me.Adapter.DeleteCommand.Parameters(96).Value = Global.System.DBNull.Value
            End If
            If (Original_Unarchived_Date_SD.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(97).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(98).Value = CType(Original_Unarchived_Date_SD.Value,Date)
            Else
        ...
        Public Overloads Overridable Function Insert( _
                    ...
                    ByVal Promote_BB As Boolean,  _
                    ByVal Packaged As Boolean,  _
                    ByVal Package_Date As Global.System.Nullable(Of Date),  _
                    ByVal Package_Filename As String,  _
                    ByVal Missing As Boolean,  _
                    ByVal Archived As Boolean,  _
                    ByVal Archived_Date As Global.System.Nullable(Of Date),  _
                    ByVal Unarchived_Date As Global.System.Nullable(Of Date),  _
                    ByVal Packaged_SD As Boolean,  _
                    ByVal Package_Date_SD As Global.System.Nullable(Of Date),  _
                    ByVal Package_Filename_SD As String,  _
                    ByVal Missing_SD As Boolean,  _
                    ByVal Archived_SD As Boolean,  _
                    ByVal Archived_Date_SD As Global.System.Nullable(Of Date),  _
                    ByVal Unarchived_Date_SD As Global.System.Nullable(Of Date)) As Integer
            ...
            End If
            Me.Adapter.InsertCommand.Parameters(35).Value = CType(Promote_BB,Boolean)
            Me.Adapter.InsertCommand.Parameters(36).Value = CType(Packaged,Boolean)
            If (Package_Date.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(37).Value = CType(Package_Date.Value,Date)
            Else
                Me.Adapter.InsertCommand.Parameters(37).Value = Global.System.DBNull.Value
            End If
            If (Package_Filename Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(38).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(38).Value = CType(Package_Filename,String)
            End If
            Me.Adapter.InsertCommand.Parameters(39).Value = CType(Missing,Boolean)
            Me.Adapter.InsertCommand.Parameters(40).Value = CType(Archived,Boolean)
            If (Archived_Date.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(41).Value = CType(Archived_Date.Value,Date)
            Else
                Me.Adapter.InsertCommand.Parameters(41).Value = Global.System.DBNull.Value
            End If
            If (Unarchived_Date.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(42).Value = CType(Unarchived_Date.Value,Date)
            Else
                Me.Adapter.InsertCommand.Parameters(42).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.InsertCommand.Parameters(43).Value = CType(Packaged_SD,Boolean)
            If (Package_Date_SD.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(44).Value = CType(Package_Date_SD.Value,Date)
            Else
                Me.Adapter.InsertCommand.Parameters(44).Value = Global.System.DBNull.Value
            End If
            If (Package_Filename_SD Is Nothing) Then
                Me.Adapter.InsertCommand.Parameters(45).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(45).Value = CType(Package_Filename_SD,String)
            End If
            Me.Adapter.InsertCommand.Parameters(46).Value = CType(Missing_SD,Boolean)
            Me.Adapter.InsertCommand.Parameters(47).Value = CType(Archived_SD,Boolean)
            If (Archived_Date_SD.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(48).Value = CType(Archived_Date_SD.Value,Date)
            Else
                Me.Adapter.InsertCommand.Parameters(48).Value = Global.System.DBNull.Value
            End If
            If (Unarchived_Date_SD.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(49).Value = CType(Unarchived_Date_SD.Value,Date)
            Else
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Archived_SD As Boolean,  _
                    ByVal Archived_Date_SD As Global.System.Nullable(Of Date),  _
                    ByVal Unarchived_Date_SD As Global.System.Nullable(Of Date),  _
                    ByVal Original_ID As Integer,  _
                    ByVal Original_UID As String,  _
                    ByVal Original_Title As String,  _
                    ByVal Original_Filename As String,  _
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(35).Value = CType(Promote_BB,Boolean)
            Me.Adapter.UpdateCommand.Parameters(36).Value = CType(Packaged,Boolean)
            If (Package_Date.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(37).Value = CType(Package_Date.Value,Date)
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(38).Value = CType(Package_Filename,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(39).Value = CType(Missing,Boolean)
            Me.Adapter.UpdateCommand.Parameters(40).Value = CType(Archived,Boolean)
            If (Archived_Date.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(41).Value = CType(Archived_Date.Value,Date)
            Else
                Me.Adapter.UpdateCommand.Parameters(41).Value = Global.System.DBNull.Value
            End If
            If (Unarchived_Date.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(42).Value = CType(Unarchived_Date.Value,Date)
            Else
                Me.Adapter.UpdateCommand.Parameters(42).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(43).Value = CType(Packaged_SD,Boolean)
            If (Package_Date_SD.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(44).Value = CType(Package_Date_SD.Value,Date)
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(45).Value = CType(Package_Filename_SD,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(46).Value = CType(Missing_SD,Boolean)
            Me.Adapter.UpdateCommand.Parameters(47).Value = CType(Archived_SD,Boolean)
            If (Archived_Date_SD.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(48).Value = CType(Archived_Date_SD.Value,Date)
            Else
                Me.Adapter.UpdateCommand.Parameters(48).Value = Global.System.DBNull.Value
            End If
            If (Unarchived_Date_SD.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(49).Value = CType(Unarchived_Date_SD.Value,Date)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(52).Value = CType(Original_UID,String)
            End If
            If (Original_Title Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(54).Value = CType(Original_Title,String)
            End If
            If (Original_Filename Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(56).Value = CType(Original_Filename,String)
            End If
            If (Original_Location_ID.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(57).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(58).Value = CType(Original_Location_ID.Value,Integer)
            Else
            ...
            If (Original_Type_ID.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(60).Value = CType(Original_Type_ID.Value,Integer)
            Else
                Me.Adapter.UpdateCommand.Parameters(59).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(60).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(61).Value = CType(0,Object)
            Me.Adapter.UpdateCommand.Parameters(62).Value = CType(Original_Promote_Five,Boolean)
            Me.Adapter.UpdateCommand.Parameters(63).Value = CType(0,Object)
            Me.Adapter.UpdateCommand.Parameters(64).Value = CType(Original_Promote_Five_Star,Boolean)
            Me.Adapter.UpdateCommand.Parameters(65).Value = CType(0,Object)
            Me.Adapter.UpdateCommand.Parameters(66).Value = CType(Original_Promote_Five_US,Boolean)
            Me.Adapter.UpdateCommand.Parameters(67).Value = CType(0,Object)
            Me.Adapter.UpdateCommand.Parameters(68).Value = CType(Original_Promote_Demand_Five,Boolean)
            Me.Adapter.UpdateCommand.Parameters(69).Value = CType(0,Object)
            Me.Adapter.UpdateCommand.Parameters(70).Value = CType(Original_Use_DVE,Boolean)
            Me.Adapter.UpdateCommand.Parameters(71).Value = CType(0,Object)
            Me.Adapter.UpdateCommand.Parameters(72).Value = CType(Original_Use_Menu,Boolean)
            If (Original_First_Use.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(73).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(74).Value = CType(Original_First_Use.Value,Date)
            Else
            ...
            If (Original_Last_Use.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(76).Value = CType(Original_Last_Use.Value,Date)
            Else
                Me.Adapter.UpdateCommand.Parameters(75).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(76).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(77).Value = CType(0,Object)
            Me.Adapter.UpdateCommand.Parameters(78).Value = CType(Original_Generic,Boolean)
            If (Original_Created.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(79).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(80).Value = CType(Original_Created.Value,Date)
            Else
            ...
            If (Original_Modified.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(82).Value = CType(Original_Modified.Value,Date)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(84).Value = CType(Original_Producer,String)
            End If
            If (Original_Prog_TX_Start.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(85).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(86).Value = CType(Original_Prog_TX_Start.Value,Date)
            Else
            ...
            If (Original_Prog_TX_End.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(88).Value = CType(Original_Prog_TX_End.Value,Date)
            Else
            ...
            If (Original_Delivery_Date.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(90).Value = CType(Original_Delivery_Date.Value,Date)
            Else
            ...
            If (Original_Duration.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(92).Value = CType(Original_Duration.Value,Date)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(94).Value = CType(Original_Delivery_1,String)
            End If
            If (Original_Delivery_2 Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(96).Value = CType(Original_Delivery_2,String)
            End If
            If (Original_Delivery_3 Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(98).Value = CType(Original_Delivery_3,String)
            End If
            If (Original_Format_1 Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(100).Value = CType(Original_Format_1,String)
            End If
            If (Original_Format_2 Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(102).Value = CType(Original_Format_2,String)
            End If
            If (Original_Format_3 Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(104).Value = CType(Original_Format_3,String)
            End If
            If (Original_Location_1 Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(106).Value = CType(Original_Location_1,String)
            End If
            If (Original_Location_2 Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(108).Value = CType(Original_Location_2,String)
            End If
            If (Original_Location_3 Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(110).Value = CType(Original_Location_3,String)
            End If
            If (Original_Delivery_Notes Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(112).Value = CType(Original_Delivery_Notes,String)
            End If
            If (Original_Spreadsheet Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(114).Value = CType(Original_Spreadsheet,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(115).Value = CType(0,Object)
            Me.Adapter.UpdateCommand.Parameters(116).Value = CType(Original_Use_USA_Menu_BG,Boolean)
            If (Original_Circle_Treatment_ID.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(117).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(118).Value = CType(Original_Circle_Treatment_ID.Value,Integer)
            Else
                Me.Adapter.UpdateCommand.Parameters(117).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(118).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(119).Value = CType(0,Object)
            Me.Adapter.UpdateCommand.Parameters(120).Value = CType(Original_Promote_BB,Boolean)
            Me.Adapter.UpdateCommand.Parameters(121).Value = CType(0,Object)
            Me.Adapter.UpdateCommand.Parameters(122).Value = CType(Original_Packaged,Boolean)
            If (Original_Package_Date.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(123).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(124).Value = CType(Original_Package_Date.Value,Date)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(126).Value = CType(Original_Package_Filename,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(127).Value = CType(0,Object)
            Me.Adapter.UpdateCommand.Parameters(128).Value = CType(Original_Missing,Boolean)
            Me.Adapter.UpdateCommand.Parameters(129).Value = CType(0,Object)
            Me.Adapter.UpdateCommand.Parameters(130).Value = CType(Original_Archived,Boolean)
            If (Original_Archived_Date.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(131).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(132).Value = CType(Original_Archived_Date.Value,Date)
            Else
            ...
            If (Original_Unarchived_Date.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(134).Value = CType(Original_Unarchived_Date.Value,Date)
            Else
            ...
            Me.Adapter.UpdateCommand.Parameters(136).Value = CType(Original_Packaged_SD,Boolean)
            If (Original_Package_Date_SD.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(137).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(138).Value = CType(Original_Package_Date_SD.Value,Date)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(140).Value = CType(Original_Package_Filename_SD,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(141).Value = CType(0,Object)
            Me.Adapter.UpdateCommand.Parameters(142).Value = CType(Original_Missing_SD,Boolean)
            Me.Adapter.UpdateCommand.Parameters(143).Value = CType(0,Object)
            Me.Adapter.UpdateCommand.Parameters(144).Value = CType(Original_Archived_SD,Boolean)
            If (Original_Archived_Date_SD.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(145).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(146).Value = CType(Original_Archived_Date_SD.Value,Date)
            Else
            ...
            If (Original_Unarchived_Date_SD.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(148).Value = CType(Original_Unarchived_Date_SD.Value,Date)
            Else
