...
Partial Public Class mm_phase_5DataSet
    ...
    Partial Public Class Gemini_MediaDataTable
        ...
        Public Overloads Function AddGemini_MediaRow( _
                    ...
                    ByVal Ignore_SD As Boolean) As Gemini_MediaRow
    ...
    Partial Public Class Gemini_MediaTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Gemini_Media` WHERE ((`ID` = ?) AND ((? = 1 AND `UID` IS NULL) OR (`"& _ 
                ...
                "`Ignore_SD` IS NULL) OR (`Ignore_SD` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Gemini_Media` (`UID`, `Title`, `Filename`, `Location_ID`, `Type_ID`,"& _ 
                ...
                "_SD`, `Archived_Date_SD`, `Unarchived_Date_SD`, `Ignore_HD`, `Ignore_SD`) VALUES"& _ 
                " (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, "& _ 
                "?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Gemini_Media` SET `UID` = ?, `Title` = ?, `Filename` = ?, `Location_ID` ="& _ 
                ...
                " = ?, `Ignore_HD` = ?, `Ignore_SD` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `UID` I"& _ 
                "S NULL) OR (`UID` = ?)) AND ((? = 1 AND `Title` IS NULL) OR (`Title` = ?)) AND ("& _ 
                "(? = 1 AND `Filename` IS NULL) OR (`Filename` = ?)) AND ((? = 1 AND `Location_ID"& _ 
                "` IS NULL) OR (`Location_ID` = ?)) AND ((? = 1 AND `Type_ID` IS NULL) OR (`Type_"& _ 
                "ID` = ?)) AND ((? = 1 AND `Promote_Five` IS NULL) OR (`Promote_Five` = ?)) AND ("& _ 
                "(? = 1 AND `Promote_Five_Star` IS NULL) OR (`Promote_Five_Star` = ?)) AND ((? = "& _ 
                "1 AND `Promote_Five_US` IS NULL) OR (`Promote_Five_US` = ?)) AND ((? = 1 AND `Pr"& _ 
                "omote_Demand_Five` IS NULL) OR (`Promote_Demand_Five` = ?)) AND ((? = 1 AND `Use"& _ 
                "_DVE` IS NULL) OR (`Use_DVE` = ?)) AND ((? = 1 AND `Use_Menu` IS NULL) OR (`Use_"& _ 
                "Menu` = ?)) AND ((? = 1 AND `First_Use` IS NULL) OR (`First_Use` = ?)) AND ((? ="& _ 
                " 1 AND `Last_Use` IS NULL) OR (`Last_Use` = ?)) AND ((? = 1 AND `Generic` IS NUL"& _ 
                "L) OR (`Generic` = ?)) AND ((? = 1 AND `Created` IS NULL) OR (`Created` = ?)) AN"& _ 
                "D ((? = 1 AND `Modified` IS NULL) OR (`Modified` = ?)) AND ((? = 1 AND `Producer"& _ 
                "` IS NULL) OR (`Producer` = ?)) AND ((? = 1 AND `Prog_TX_Start` IS NULL) OR (`Pr"& _ 
                "og_TX_Start` = ?)) AND ((? = 1 AND `Prog_TX_End` IS NULL) OR (`Prog_TX_End` = ?)"& _ 
                ") AND ((? = 1 AND `Delivery_Date` IS NULL) OR (`Delivery_Date` = ?)) AND ((? = 1"& _ 
                " AND `Duration` IS NULL) OR (`Duration` = ?)) AND ((? = 1 AND `Delivery_1` IS NU"& _ 
                "LL) OR (`Delivery_1` = ?)) AND ((? = 1 AND `Delivery_2` IS NULL) OR (`Delivery_2"& _ 
                "` = ?)) AND ((? = 1 AND `Delivery_3` IS NULL) OR (`Delivery_3` = ?)) AND ((? = 1"& _ 
                " AND `Format_1` IS NULL) OR (`Format_1` = ?)) AND ((? = 1 AND `Format_2` IS NULL"& _ 
                ") OR (`Format_2` = ?)) AND ((? = 1 AND `Format_3` IS NULL) OR (`Format_3` = ?)) "& _ 
                "AND ((? = 1 AND `Location_1` IS NULL) OR (`Location_1` = ?)) AND ((? = 1 AND `Lo"& _ 
                "cation_2` IS NULL) OR (`Location_2` = ?)) AND ((? = 1 AND `Location_3` IS NULL) "& _ 
                "OR (`Location_3` = ?)) AND ((? = 1 AND `Delivery_Notes` IS NULL) OR (`Delivery_N"& _ 
                "otes` = ?)) AND ((? = 1 AND `Spreadsheet` IS NULL) OR (`Spreadsheet` = ?)) AND ("& _ 
                "(? = 1 AND `Use_USA_Menu_BG` IS NULL) OR (`Use_USA_Menu_BG` = ?)) AND ((? = 1 AN"& _ 
                "D `Circle_Treatment_ID` IS NULL) OR (`Circle_Treatment_ID` = ?)) AND ((? = 1 AND"& _ 
                " `Promote_BB` IS NULL) OR (`Promote_BB` = ?)) AND ((? = 1 AND `Packaged` IS NULL"& _ 
                ") OR (`Packaged` = ?)) AND ((? = 1 AND `Package_Date` IS NULL) OR (`Package_Date"& _ 
                "` = ?)) AND ((? = 1 AND `Package_Filename` IS NULL) OR (`Package_Filename` = ?))"& _ 
                " AND ((? = 1 AND `Missing` IS NULL) OR (`Missing` = ?)) AND ((? = 1 AND `Archive"& _ 
                "d` IS NULL) OR (`Archived` = ?)) AND ((? = 1 AND `Archived Date` IS NULL) OR (`A"& _ 
                "rchived Date` = ?)) AND ((? = 1 AND `Unarchived Date` IS NULL) OR (`Unarchived D"& _ 
                "ate` = ?)) AND ((? = 1 AND `Packaged_SD` IS NULL) OR (`Packaged_SD` = ?)) AND (("& _ 
                "? = 1 AND `Package_Date_SD` IS NULL) OR (`Package_Date_SD` = ?)) AND ((? = 1 AND"& _ 
                " `Package_Filename_SD` IS NULL) OR (`Package_Filename_SD` = ?)) AND ((? = 1 AND "& _ 
                "`Missing_SD` IS NULL) OR (`Missing_SD` = ?)) AND ((? = 1 AND `Archived_SD` IS NU"& _ 
                "LL) OR (`Archived_SD` = ?)) AND ((? = 1 AND `Archived_Date_SD` IS NULL) OR (`Arc"& _ 
                "hived_Date_SD` = ?)) AND ((? = 1 AND `Unarchived_Date_SD` IS NULL) OR (`Unarchiv"& _ 
                "ed_Date_SD` = ?)) AND ((? = 1 AND `Ignore_HD` IS NULL) OR (`Ignore_HD` = ?)) AND"& _ 
                " ((? = 1 AND `Ignore_SD` IS NULL) OR (`Ignore_SD` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        ID, UID, Title, Filename, Location_ID, Type_ID, Promote_Five, Promo"& _ 
                "te_Five_Star, Promote_Five_US, Promote_Demand_Five, Use_DVE, Use_Menu, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"       "& _ 
                "                  First_Use, Last_Use, Generic, Created, Modified, Producer, Pro"& _ 
                "g_TX_Start, Prog_TX_End, Delivery_Date, Notes, Duration, Delivery_1, Delivery_2,"& _ 
                " "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Delivery_3, Format_1, Format_2, Format_3, Location_1"& _ 
                ", Location_2, Location_3, Delivery_Notes, Spreadsheet, Use_USA_Menu_BG, Circle_T"& _ 
                "reatment_ID, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Promote_BB, Packaged, Package_Date, Pack"& _ 
                "age_Filename, Missing, Archived, [Archived Date], [Unarchived Date], Packaged_SD"& _ 
                ", Package_Date_SD, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Package_Filename_SD, Missing_SD, A"& _ 
                "rchived_SD, Archived_Date_SD, Unarchived_Date_SD, Ignore_HD, Ignore_SD"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM    "& _ 
                "        Gemini_Media"
